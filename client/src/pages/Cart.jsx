...
const Cart = () => {
  const { cart, address, isLoading, selectedAddress, setSelectedAddress, handleOrder, setPaymentType, paymentType, removeFromCart, updateCartQuantity } = useContext(AppContext);
  ...
  const totalPrice = cart.reduce((sum, item) => sum + item.offerPrice * item.quantity, 0);
  ...
  if (isLoading) {
    return <div className="w-[92%] md:w-[85%] mx-auto mt-12 mb-28">Loading...</div>;
  }
                    ...
                    <div className="flex flex-col gap-1 sm:gap-2">
                      ...
                      <div className="flex items-center gap-2 mt-1">
                        ...
                        <div className="flex items-center gap-1">
                          <button
                            onClick={(e) => handleCartMinus(e, cartItem.id, cartItem.quantity)}
                          ...
                          <button
                            onClick={(e) => handleCartPlus(e, cartItem.id, cartItem.inStock, cartItem.quantity)}
                            className="w-6 h-6 sm:w-7 sm:h-7 border rounded-md text-gray-700 hover:bg-gray-100 disabled:opacity-50 text-sm"
        ...
        <div className="w-full md:w-[60%] xl:w-[30%] bg-gray-100 p-4 sm:p-6 rounded-sm h-fit sticky top-4">
          ...
          <div className='mt-3 mb-3'>
            ...
            <div className='flex w-full justify-between relative mt-1 sm:mt-2'>
              ...
              {showAddress && (
                <div className='absolute top-8 sm:top-10 right-0 flex flex-col w-full text-gray-500 border rounded-sm border-gray-300 bg-white z-10 shadow-md'>
                  <select
                    onChange={(e) => {
                      setSelectedAddress(
